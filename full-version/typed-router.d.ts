...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'budget-budget': RouteRecordInfo<'budget-budget', '/budget/budget', Record<never, never>, Record<never, never>>,
    'budget-color': RouteRecordInfo<'budget-color', '/budget/color', Record<never, never>, Record<never, never>>,
    'budget-customer': RouteRecordInfo<'budget-customer', '/budget/customer', Record<never, never>, Record<never, never>>,
    'budget-employee': RouteRecordInfo<'budget-employee', '/budget/employee', Record<never, never>, Record<never, never>>,
    'budget-product': RouteRecordInfo<'budget-product', '/budget/product', Record<never, never>, Record<never, never>>,
    'budget-products': RouteRecordInfo<'budget-products', '/budget/products', Record<never, never>, Record<never, never>>,
    'budget-supplier': RouteRecordInfo<'budget-supplier', '/budget/supplier', Record<never, never>, Record<never, never>>,
    'catalogo-catalogo': RouteRecordInfo<'catalogo-catalogo', '/catalogo/:catalogo', { catalogo: ParamValue<true> }, { catalogo: ParamValue<false> }>,
    'catalogo-catalogo-linea-linea': RouteRecordInfo<'catalogo-catalogo-linea-linea', '/catalogo/:catalogo/linea/:linea', { catalogo: ParamValue<true>, linea: ParamValue<true> }, { catalogo: ParamValue<false>, linea: ParamValue<false> }>,
    'catalogo-catalogo-linea-linea-producto-producto': RouteRecordInfo<'catalogo-catalogo-linea-linea-producto-producto', '/catalogo/:catalogo/linea/:linea/producto/:producto', { catalogo: ParamValue<true>, linea: ParamValue<true>, producto: ParamValue<true> }, { catalogo: ParamValue<false>, linea: ParamValue<false>, producto: ParamValue<false> }>,
    ...
    'dashboards-ashley': RouteRecordInfo<'dashboards-ashley', '/dashboards/ashley', Record<never, never>, Record<never, never>>,
    'dashboards-blue-room': RouteRecordInfo<'dashboards-blue-room', '/dashboards/blue-room', Record<never, never>, Record<never, never>>,
    'dashboards-spiga': RouteRecordInfo<'dashboards-spiga', '/dashboards/spiga', Record<never, never>, Record<never, never>>,
    'dashboards-tamarindo': RouteRecordInfo<'dashboards-tamarindo', '/dashboards/tamarindo', Record<never, never>, Record<never, never>>,
