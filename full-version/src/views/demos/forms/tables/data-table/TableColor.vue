...
import data from '@/views/demos/forms/tables/data-table/datatablecolor'
...
// headers
const headers = [
  { title: 'N° de Producto', key: 'email' },
  { title: 'Color Silleria', key: 'color' },
  { title: 'Tono/Base', key: 'startDate' },
  { title: 'Estructura', key: 'age' },
  { title: 'Silla (Img)', key: 'salary' },
