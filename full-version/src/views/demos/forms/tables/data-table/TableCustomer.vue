...
import data from '@/views/demos/forms/tables/data-table/datatablesupplier'
...
// headers
const headers = [
  { title: 'Empresa', key: 'email' },
  { title: 'Razon Social', key: 'age' },
  { title: 'Direccion', key: 'fullName' },
  { title: 'Vendedor', key: 'salary' },
...
<template>
  ...
  >
    ...
    <template #item.fullName="{ item }">
      <div class="d-flex align-center">
        ...
        <div class="d-flex flex-column ms-3">
          <span class="d-block text-truncate">{{ item.fullName }}</span>
    ...
    <template #item.salary="{ item }">
      <div class="d-flex align-center">
        <div class="d-flex flex-column ms-3">
          <span class="d-block text-truncate">{{ item.salary }}</span>
          <small>{{ item.post1 }}</small>
          <!-- Puedes cambiar esto según el formato de salario -->
        </div>
      </div>
    </template>
    <!-- status -->
