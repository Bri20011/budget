...
import data from '@/views/demos/forms/tables/data-table/datatablecustomer'
...
// headers
const headers = [
  { title: 'Razon Social', key: 'fullName' },
  { title: 'Empresa', key: 'email' },
  { title: 'Alcandia', key: 'age' },
  { title: 'N° Vendedor', key: 'startDate' },
